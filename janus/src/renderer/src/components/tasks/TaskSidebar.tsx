...
import { Boxes, ChevronDown, Files, FlaskConical, FolderGit2, ListTodo, MessageSquarePlus, Plus, Sun, Trash2 } from 'lucide-react'
  ...
  return (
    <aside className="resource-sidebar">
      ...
      <nav className="task-sidebar-nav" aria-label="기본 탐색">
        <button aria-current={activeNavigation === 'today' ? 'page' : undefined} onClick={() => onNavigate?.('today')}><Sun size={14} /> 오늘</button>
